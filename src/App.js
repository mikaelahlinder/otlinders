...
export default () => (
  <div>
    ...
    <section>
      ...
      <Image src='ms.jpg' style={{ transform: 'rotateY(-180deg)', height: '30vh' }} />
    </section>
    ...
    >
      ...
      <div>
        ...
        <p>
          A beautiful{' '}
          <a href='https://www.kauribayboomrock.co.nz/' rel='noopener noreferrer' target='_blank'>
            venue
          </a>{' '}
      ...
      <div>
        ...
        <p>
          A bit dressy
          <Image src='highheel.png' style={{ height: '2em', margin: '0 0 -5px 5px' }} />
        </p>
      </div>
      ...
      <div>
        ...
        <p>
          Please bring one or a few flowers to the ceremony. Choose something meaningful or simply what you like the
          look of. You are helping us to create our ceremony centrepiece.
        </p>
      </div>
      ...
      <div>
        <h3>Key Times</h3>
        <p>
          The ceremony starts at 2.30pm &<br /> the dancing finishes at midnight!
        </p>
      </div>
      ...
      >
        <h3>Transport</h3>
        <p>
          The car parking at Boomrock is limited to suppliers and staff. Please do not drive to the venue. Instead,
          please taxi or drive to one of the bus pick up points.
          <br /> <br />
          ...
          coach stop outside Countdown (Great South Rd) soon after. Returning buses to Greenlane and Hobson St will
          depart the venue at midnight. Due to it’s remote location, any taxis must be prebooked. <br /> <br />
          Please include any special travel requirements in your R.S.V.P and we can make the best plan together.
          <br />
        </p>
      </div>
      ...
      <div>
        <h3>Gifts</h3>
        <p>
          We are blessed with not needing much and Sarah collects too much stuff as it is!
          <br /> <br /> We are planning to build a new room in our townhouse; for you to stay and maybe eventually for a
          sibling to Lou. If you would like to contribute to our Fifth Room Family Fund, we would be so grateful!
          <br /> <br />
      ...
      <div>
        <h3>Photos</h3>
        <Image src='eyes.png' style={{ height: '2em', margin: '0 0 -5px 5px' }} />
        <p>
          Our ceremony will be unplugged, only designated photographers will have devices in hand :) Throughout the rest
          of the day, use{' '}
          <a target='_blank' href='https://www.instagram.com/explore/tags/theotlinders/' rel='noopener noreferrer'>
            #theotlinders
          </a>{' '}
          as much as you wish!
        </p>
      ...
      <div>
        ...
        <p>
          We love your children! But for this event, we have chosen to limit the number of little people to just
          immediate family and those travelling from abroad.
        </p>
      </div>
      ...
      <div>
        <h3>Speeches</h3>
        <p>
          We're gonna do this the Swedish way, meaning anyone who wants to talk can. Contact{' '}
    ...
    <section>
      <h2>
        R<span style={{ fontFamily: 'Futura', color: 'red', fontSize: '1em' }}>.</span>S
        <span style={{ fontFamily: 'Futura', color: 'red', fontSize: '1em' }}>.</span>V
        <span style={{ fontFamily: 'Futura', color: 'red', fontSize: '1em' }}>.</span>P
        <span style={{ fontFamily: 'Futura', color: 'red', fontSize: '1em' }}>.</span>
      </h2>

      <p>
        By November 1st to <a href='mailto:rsvp@otlinders.com'>rsvp@otlinders.com</a>
        <br />
    ...
    <section>
      ...
      <p>
        ...
        <br /> Stay up as long as possible on the first day and you’ll be right after a few sleeps!
        <br />
        <br />
        ...
        <br /> The coconut yoghurt section in the supermarket offers more than your average fil aisle.
        <br />
    ...
    <section>
      ...
      <p>
        ...
        <br />
        <br />
        ABBA, Volvo, Ikea, H&M, Spotify, Skype, Zlatan Ibrahimovic, Socialism: <strong>YES</strong>
        <br />
        Cheese with holes, chocolate, watch industry, really wealthy: <strong>NO, that's Switzerland!</strong>
      </p>
    </section>
